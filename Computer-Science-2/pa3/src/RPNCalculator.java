...
public class RPNCalculator {
    ...
    */
    public double exp() {
        return stack.push(Math.exp(pop()));
    }
    ...
    */
    public double log() {
        return stack.push(Math.log(pop()));
    }
    ...
    */
    public double sin() {
        return stack.push(Math.sin(pop()));
    }
    ...
    */
    public double cos() {
        return stack.push(Math.cos(pop()));
    }
    ...
    */
    public double sqrt() {
        return stack.push(Math.sqrt(pop()));
    }
    ...
    public void processLine(String line) throws CalculatorException {
        ...
        while ( linescan.hasNext() ) {
            ...
            else if ( linescan.hasNext(identToken) )
            {
                ...
                */
                throw new CalculatorException("Cannot process '"+linescan.next() + "'");
        }
    }
