...
public class TestClass {
    ...
    public void testListInt_deleteNode()
    {
        ...
        assertTrue(intListTester.containValue(3));
        intListTester.deleteNode(3);
        assertFalse(intListTester.containValue(3));

        intListTester.addFirst(1);
        assertTrue(intListTester.containValue(1));
        intListTester.deleteNode(1);

        assertFalse(intListTester.containValue(1));
    }
